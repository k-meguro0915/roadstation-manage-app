...
__webpack_require__(/*! ./bootstrap.bundle.min.js */ "./resources/js/bootstrap.bundle.min.js");
/**
...
window.changeIsService = function (id) {
  var span = document.getElementById('service-btn-' + id);
  var checkbox = document.getElementById('service-checkbox-' + id);
